...
<%@page import="com.bridgelabz.model.Cart"%>
<%@page import="com.bridgelabz.model.User"%>
<%@page import="com.bridgelabz.dao.*"%>
<%@page import="com.bridgelabz.connection.*"%>
					...
					<td>
						<form action="order-now" method="post" class="form-inline">
							<input type="hidden" name="id" value="c.getId()"
								...
								<input type="text" name="quantity" class="form-control w-10"  value="<%=c.getQuantity()%>" readonly> 
